              ...
              {isEditing ? (
                <form onSubmit={handleSubmit} className="profile-edit-form">
                  ...
                  <div className="profile-form-group profile-notifications-toggle">
                    <label
                      className="profile-toggle-label"
                    ...
                    >
                      ...
                      <div className="profile-toggle-content">
                        <div className="profile-toggle-info">
                          <span className="profile-toggle-title">
                            Email Notifications
                          </span>
                ...
                <div className="profile-info-grid">
                  <div className="profile-info-item">
                    ...
                    <span id="firstname-current" className="profile-info-value">
                      {user.firstName}
                    </span>
                  </div>
                  <div className="profile-info-item">
                    <span className="profile-info-label">Last Name</span>
                    <span id="lastname-current" className="profile-info-value">
                      {user.lastName}
                    </span>
                  </div>
                  <div className="profile-info-item">
                    <span className="profile-info-label">Username</span>
                    <span id="username-current" className="profile-info-value">
                      {user.username}
                    </span>
                  </div>
                  <div className="profile-info-item">
                    <span className="profile-info-label">Email</span>
                    <span id="email-current" className="profile-info-value">
                      {user.email}
                    </span>
                  </div>
                  ...
                  <div className="profile-info-item">
                    ...
                    <span id="email-current" className="profile-info-value">
                      {user.emailNotificationsEnabled ? "yes" : "no"}
                    </span>
                  </div>
                </div>
              )}
