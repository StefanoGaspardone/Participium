...
export class ReportDAO {
  ...
  @IsNotEmpty({
    message: "Rejected description cannot be empty for a rejected report",
  })
  ...
  @ManyToOne(() => UserDAO, (user) => user.coAssignedReports)
  @JoinColumn({ name: "co_assigned_to_id" })
  @ValidateIf((o) =>
    [
      ReportStatus.Assigned,
      ReportStatus.InProgress,
  ...
  /* NO relation pointing to the chats related to the report yet, better to extract that information from chat table if needed*/
}
